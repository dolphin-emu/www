...
# trailing slash.
# Do not use protocol-relative URLs because some crawlers (e.g. Twitter's)
# consider them invalid.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = 'https://dolphin-emu.org/m/user/'
...
STATIC_URL = 'https://dolphin-emu.org/m/static/'
...
GIT_TAG_URL = "https://github.com/dolphin-emu/dolphin/releases/tag/"
